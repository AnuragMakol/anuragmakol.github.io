...
export function Error404(props) {
  ...
  return (
    <WebsiteLayout props={props} headerVisible={false} footerVisible={false}> 
      <div className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 h-screen">
        <div className="text-center">
          ...
          <a onClick={() => navigate('/')} className="rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90">Back to AppVertix.com</a>
        </div>
      </div>
    </WebsiteLayout>
  )
