...
export function Plans(props) {
    ...
    const CancelPlan = () => {
        Swal.fire({
            title: "Are you sure?",
            html: 'This will cancel the subscription to the Ultimate Plan and remove access to the custom/predefined templates',
            icon: 'error',
                    ...
                    <table className="table-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border-t border-stroke px-7 py-5 dark:border-strokedark">
                                    <p className="text-center font-medium">1 Template</p>
                                </td>
                                <td className="border-t border-stroke px-7 py-5 dark:border-strokedark">
                            ...
                            <tr>
                                <td className="border-t border-stroke px-7 py-5 dark:border-strokedark">
                                    <p className="font-medium">Custom Template Support</p>
                                </td>
                                <td className="border-t border-stroke px-7 py-5 dark:border-strokedark">
