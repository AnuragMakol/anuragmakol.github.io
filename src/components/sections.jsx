                        ...
                        <div className="relative flex h-24 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start" >
                                ...
                                <div className="hidden sm:mx-auto sm:block">
                                    <div className="flex space-x-4">
                                        <a href="#about" className="px-3 py-2 font-semibold text-sm text-white uppercase" aria-current="page">About</a >
                                        <a href="#services" className="px-3 py-2 font-semibold text-sm text-white uppercase" >Services</a >
                                        <a href="#portfolio" className="px-3 py-2 font-semibold text-sm text-white uppercase" >Portfolio</a >
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0" >
                                <div className="relative ml-3">
                                    <div>
                                        <a href="#contact" type="button" className="btn btn-primary uppercase font-semibold text-sm group">
            ...
            <div className="container">
                <div className="grid grid-cols-4 gap-6 mb-16">
                    <div>
                        ...
                        <a href="mailto:contact@appvertix.com" className="text-gray-50 hover:text-gray-200 font-bold text-xl flex mb-7" > contact@appvertix.com </a>
                        <div className="flex">
				...
				<ul>
                    ...
                    <div>
                        ...
                        <div className="subscribtion-area">
                            ...
                            <form action="#" className="bg-gray-800 p-2 rounded flex">
                                <input id="email" type="email" placeholder="Enter your email..." className="px-3 py-1.5 flex-grow mr-2" required />
