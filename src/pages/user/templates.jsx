                                ...
                                <div className="mb-5.5">
                                    ...
                                    <div className="relative z-20 bg-white">
                                        <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 pl-5 pr-12 outline-none transition focus:border-primary active:border-primary" {...registerUpdateWidgetTemplate('widget_template')}>
                                            ...
                                            <option value="t1-s3">Template 1 - Style 3</option>
                                            <option value="t1-s4">Template 1 - Style 4</option>
                                            <option value="t1-s5">Template 1 - Style 5</option>
                                            <option value="t1-s6">Template 1 - Style 6</option>
                                            <option value="t2-s1">Template 2 - Style 1</option>
                                            <option value="t2-s2">Template 2 - Style 2</option>
                                            <option value="t2-s3">Template 2 - Style 3</option>
                                            <option value="t2-s4">Template 2 - Style 4</option>
                                            <option value="t2-s5">Template 2 - Style 5</option>
                                            <option value="t2-s6">Template 2 - Style 6</option>
                                            <option value="t3-s1">Template 3 - Style 1</option>
                                            <option value="t3-s2">Template 3 - Style 2</option>
                                            <option value="t3-s3">Template 3 - Style 3</option>
                                            <option value="t3-s4">Template 3 - Style 4</option>
                                            <option value="t3-s5">Template 3 - Style 5</option>
                                            <option value="t3-s6">Template 3 - Style 6</option>
