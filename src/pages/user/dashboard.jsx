      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <h4 className="text-title-md font-bold text-black dark:text-white">{statistics?.monthly?.views.$numberDecimal == undefined ? 0 : statistics?.monthly?.views.$numberDecimal}</h4>
        ...
        <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <h4 className="text-title-md font-bold text-black dark:text-white">{statistics?.monthly?.added_to_cart.$numberDecimal == undefined ? 0 : statistics?.monthly?.added_to_cart.$numberDecimal}</h4>
        ...
        <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <h4 className="text-title-md font-bold text-black dark:text-white">{statistics?.monthly?.conversions.$numberDecimal == undefined ? 0 : statistics?.monthly?.conversions.$numberDecimal}</h4>
        ...
        <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <h4 className="text-title-md font-bold text-black dark:text-white">{statistics?.monthly?.revenue.$numberDecimal == undefined ? 0 : statistics?.monthly?.revenue.$numberDecimal}</h4>
