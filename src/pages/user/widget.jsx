                                        ...
                                        <div className='accordion-item'>
                                            ...
                                            <div className='accordion-content px-4 pb-4'>
                                                ...
                                                <div className="flex justify-between items-center mb-4">
                                                    ...
                                                    <div className='min-w-32 max-w-32'>
                                                        <div className="relative z-20 bg-input-color">
                                                            <select className="block-select-control h-9" {...registerUpdateWidgetTemplate('urgency_bar_text_font_weight')} onChange={(e) => {
                                                                setWidgetSettings({
                                                                    ...widgetSettings,
                                                ...
                                                <div className="flex justify-between items-center mb-4">
                                                    ...
                                                    <div className='min-w-32 max-w-32'>
                                                        <div className="relative z-20 bg-input-color">
                                                            <select className="block-select-control h-9" {...registerUpdateWidgetTemplate('urgency_bar_timer_font_weight')} onChange={(e) => {
                                                                setWidgetSettings({
                                                                    ...widgetSettings,
